                    ...
                    <div className={cx("row w-100 d-flex align-items-center")}>
                        ...
                        <div className={cx("col-lg-5 col-md-4")}>
                            <div className={cx('actions')}>
                                <ActionItem icon={<Promote />} title="Khuyến mãi" to="/coupon" className={cx("d-lg-flex d-md-none")}/>
                                <ActionItem icon={<Order />} title="Đơn hàng" to="/cart" className={cx("d-lg-flex d-md-none")}/>
                                {isSignIn ? (
                                    <Menu items = {userMenu}>
