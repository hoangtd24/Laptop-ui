        ...
        <>
                                    ...
                                    <div>
                                        ...
                                        >
                                            <span className={cx('cart')}>
                                                ...
                                                {cartLists.length > 0 && (
                                                    <p className={cx('cart-quantity')}>{cartLists.length}</p>
                                                )}
                                            </span>
                                        </Tippy>
                                    </div>
            ...
            <div className={cx('header-mobile')}>
                <div className={cx('search-mobile')}>
                    <input className={cx('search-input-mobile')} placeholder="Nhập từ khóa để tìm kiếm" />
                    <button className={cx('search-btn-mobile')}>
                        <FontAwesomeIcon icon={faMagnifyingGlass} />
                    </button>
                </div>
            </div>
